...
public class ViewProfilePatientPagos extends javax.swing.JFrame {
    ...
    public ViewProfilePatientPagos(int idPaciente, int idDoctor, MenuDocPacientes menuDocPacientes) {
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Pago referencia", "Fecha de pago", "Precio Consulta", "Cantidad pagada", "Cantidad a pagar"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewProfilePatientPagos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    String sql = "SELECT IdPago, FechaPago, CantidadAPagar, CantidadPagada FROM pagos "
               + "WHERE IdPaciente = (SELECT IdPaciente FROM pacientes WHERE Identificacion = ?) AND IdDoctor = ?";
    try (PreparedStatement pst = reg.prepareStatement(sql)) {
        ...
        try (ResultSet rs = pst.executeQuery()) {
            ...
            while (rs.next()) {
                ...
                double precioConsulta = getCantidadPendiente(cantidadAPagar, cantidadPagada);

                String fechaPagoFormatted = dateFormat.format(fechaPago);
...
private double getCantidadPendiente(double cantidadAPagar, double cantidadPagada) {
    return cantidadAPagar - cantidadPagada;
}
