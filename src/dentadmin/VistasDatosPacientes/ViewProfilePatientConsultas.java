...
public class ViewProfilePatientConsultas extends javax.swing.JFrame {
    ...
    public ViewProfilePatientConsultas(int idPaciente, int idDoctor, MenuDocPacientes menuDocPacientes) {
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Fecha de la cita", "Motivo", "Tratamiento", "Precio consulta"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewProfilePatientConsultas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void mostrarConsultas() {
        ...
        String sql = "SELECT FechaCita, Motivo, Tratamiento, PrecioConsulta "
                + "FROM consultas "
